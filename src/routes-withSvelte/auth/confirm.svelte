	...
	{:else}
		...
		<div class="grid grid-cols-12 gap-4">
			<div class="col-span-12 lg:col-span-5">
				<p class="mb-2">
					We know you just clicked a magic link, but maybe you’re logging in from a
					different device to where you requested the login?
				</p>
				<p class="mb-4">
...
<script lang="ts">
	import {isMagicLink, signInWithMagicLink} from '$lib/0-firebase/client'
