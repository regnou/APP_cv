...
<svg class="iconTec" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none"
	><title>file_type_vite</title><path
	...
	/><defs id="defs50"
		...
		><linearGradient
			...
			><stop stop-color="#FFEA83" id="stop43" /><stop
				...
				stop-color="#FFDD35"
				id="stop45"
			/><stop offset="1" stop-color="#FFA800" id="stop47" /></linearGradient
		></defs
	></svg
>
