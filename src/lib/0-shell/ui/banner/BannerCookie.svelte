<Banner
	...
	<Icon slot="icon" class="material-icons">privacy_tip</Icon>

	<Label slot="label">Nous utilisons des cookies 🍪 pour personnaliser votre expérience.</Label>
	<svelte:fragment slot="actions">
		<Button secondary>Réglages</Button>
...
<script>
	...
	import ComplexeWave from '$lib/0-shell/ui/0-svg/wave/complexeWave.svelte';
	import Hero from '$lib/0-shell/ui/hero/Hero.svelte';
	// import CardList from '$lib/ecom/ui/list/CardList.svelte';
	// !! main
